...
ActiveRecord::Schema.define(:version => 20100819172912) do
  ...
  create_table "deliverables", :force => true do |t|
    ...
    t.decimal "overhead",                :precision => 15, :scale => 2
    t.decimal "materials",               :precision => 15, :scale => 2
    t.decimal "profit",                  :precision => 15, :scale => 2
    t.decimal "cost_per_hour",           :precision => 15, :scale => 2
    t.decimal "total_hours",             :precision => 15, :scale => 2
    t.decimal "fixed_cost",              :precision => 15, :scale => 2
    t.integer "overhead_percent"
    t.integer "materials_percent"
  ...
  create_table "schedule_closed_entries", :force => true do |t|
    t.integer "user_id", :default => 0, :null => false
  ...
  create_table "schedule_defaults", :force => true do |t|
    t.integer "user_id",       :default => 0, :null => false
    t.text    "weekday_hours"
  end
  ...
  create_table "wiki_extensions_settings", :force => true do |t|
    ...
    t.boolean  "sidebar_disabled",     :default => false, :null => false
  end
